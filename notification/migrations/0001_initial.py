    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_giving', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_giving_notification', to=settings.AUTH_USER_MODEL)),
                ('user_receiving', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_receiving_notification', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
